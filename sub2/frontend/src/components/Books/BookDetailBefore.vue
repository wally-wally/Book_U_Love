<template>
  <div class="book-deatil-wrapper mt-5">
    <div class="bookdetail" v-if="!loadingStatus">
      ...
      <div class="rating my-4 py-3"> <!-- 평점 -->
        <span style="color:#f9d71c">★</span>{{book.avg}} ({{book.review_cnt}}명)
      </div>
      <div class="row detailbody pb-10"> <!-- 책 기본 정보-->
        <div class="col-4">
      ...
      <div v-if="this.$store.state.user.isLogin" @click="this.jjim" style="margin-bottom:40px"> <!-- 찜 버튼 -->
      ...
      <v-card v-if="book.description" class="ctr-80 mb-5" style="width:100%;"> <!-- 책 소개 -->
      ...
      <v-card v-if="book.contents" class="ctr-80 mt-5 mb-5" style="width:100%;"> <!-- 책 목차 -->
        <v-card-title class="pt-10 pb-10 book-sub" style="text-align:center;">
        목차
        </v-card-title>
